...
@Table(name = "user_profiles", uniqueConstraints = {
		@UniqueConstraint(name = "username_uquique_constraint", columnNames = "username")
})
@Getter
@Setter
@NoArgsConstructor
...
public class UserProfile {
	...
	public String toString() {
		return "UserProfile [id=" + id + ", userId=" + user.getId() + ", username=" + username + ", firstName=" + firstName
